...
2、- 应用管理：
  ...
  - 从设备列表中选择一个设备，从“获取已安装应用”选择指定包名后，支持清理应用缓存并重启；
  - 从设备列表中选择一个设备，从“获取已安装应用”选择指定包名后，点击“停止应用运行”来终止目标应用运行。
  - 从设备列表中选择一个设备，然后选择发送信息可以发送对应的文案至Android设备粘贴板，从设备获取可以从Android设备粘贴板获取文本信息
  - 从设备列表中选择一个设备，然后点击“获取设备信息”来查看该设备的详细信息。
...
4、- 设备控制：
  ...
  - 从设备列表中选择一个设备，点击“启用无线调试”或“停用无线调试”按钮来开启或关闭无线调试功能。。首次使用需要在终端运行一次adb tcpip 5555命令；
